...
async function initDb() {
  ...
  const defaults = {
    ...
    seo_title:'Trend Wear — Modern fashion for everyday style', seo_description:'Discover refined everyday fashion from Trend Wear.', seo_keywords:'fashion, clothing, trend wear, Bangladesh', og_image:'/assets/logo.jpg', footer_copyright:'© Trend Wear. All rights reserved.', header_items:'[]', footer_columns:'[]', theme_config:'{}'
  };
